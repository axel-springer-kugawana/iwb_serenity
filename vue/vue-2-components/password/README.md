...
- [Vue 2](https://vuejs.org/v2/guide) (**for other versions of Vue, see [`iwb-serenity-password`](https://github.com/axel-springer-kugawana/iwb_serenity/vue/components/password)**)
...
```sh
cd iwb_serenity/vue/vue-2-components/password
```
...
`ERROR in …/iwb_serenity/vue/vue-2-components/password/src/index.ts(8,7):
