<!--
    This version of the component is TypeScript-compliant, but not used.
    It’s kept for history/learning purpose. See README.md for details
    about TypeScript and Vue 2 components.
-->
<!--
...
export default Vue.extend({
    ...
    computed: {
        revealed: function(): boolean {
            return this.type == "text";
        },

        stateText: function(): string {
    ...
    methods: {
         ...
         */
        handleInput: function(e: Event & { target: HTMLInputElement }) {
         ...
         */
        handleChange: function(e: Event & { target: HTMLInputElement }) {
